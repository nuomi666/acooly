 ...
 * @date 2020-04-13 17:26FMPayAlipayServiceWindowService
 */
@Slf4j
@MockGatewayAnnotationService(gatewayApi = GatewayChannelApiEnum.FMPayAlipayServiceWindowService, desc = "富民支付宝服务窗支付服务", owner = "mufanglin")
public class FMPayAlipayServiceWindowServices extends
    ...
    public void executeGateway(HttpServletRequest request, MockResponseResult result) throws Exception {
        ...
        log.info("MOCK-请求-富民支付宝服务窗支付服务-请求订单 ： {}", result.getRequestData());
        ...
        if (MockUtils.hundreds(amount) == 1){
            ...
            requestData.put("bankTransactionId", Ids.getDid(20));
            requestData.put("authUrl", "www.baidu.com");
        ...
        log.info("MOCK-请求-富民支付宝服务窗支付服务-响应订单 ： {}", result.getData());
    }
}
