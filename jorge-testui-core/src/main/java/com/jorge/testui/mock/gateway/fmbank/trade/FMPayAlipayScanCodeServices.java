 ...
 */
@Slf4j
@MockGatewayAnnotationService(gatewayApi = GatewayChannelApiEnum.FMPayAlipayScanCodeService, desc = "富民银联(支付宝)条码支付服务", owner = "mufanglin")
public class FMPayAlipayScanCodeServices extends
    ...
    public void executeGateway(HttpServletRequest request, MockResponseResult result) throws Exception {
        ...
        log.info("MOCK-请求-富民银联(支付宝)条码支付服务-请求订单 ： {}", result.getRequestData());
        ...
        log.info("MOCK-请求-富民银联(支付宝)条码支付服务-响应订单 ： {}", result.getData());
    }
}
